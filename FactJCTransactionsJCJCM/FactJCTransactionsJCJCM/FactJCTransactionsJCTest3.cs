...
namespace FactJCTransactionsJCJCM {
    public class FactJCTransactionsJCTest3Root {
        [JsonProperty("odata.metadata")]
        public string odatametadata { get; set; }
        public List<FactJCTransactionsJCTest3> value { get; set; } = new List<FactJCTransactionsJCTest3>();
    }

    public class FactJCTransactionsJCTest3 {
        ...
        public string UMPMTranOffsetAccountGroupIDIsNull { get; set; }
        public string UMPMTranAccountGroupID { get; set; }
